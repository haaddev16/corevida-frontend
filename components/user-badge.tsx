  ...
  return (
    <div ref={box} className={cn("relative z-50", className)}>
      ...
      {open && (
        <div
          role="menu"
          className="absolute top-[calc(100%+8px)] right-0 min-w-[176px] rounded-2xl border border-white/12 bg-[#081210]/92 p-1.5 shadow-[0_12px_32px_rgba(0,0,0,0.35)] backdrop-blur-md"
        >
